...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.AlterModelOptions(
            ...
            options={'verbose_name': 'Donacijska stran z embedom', 'verbose_name_plural': 'Donacijske strani z embedom'},
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('left_box_button_link', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='+', to='wagtailcore.page', verbose_name='Leva škatla - gumb povezava')),
                ('right_box_button_link', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='+', to='wagtailcore.page', verbose_name='Desna škatla - gumb povezava')),
            ],
            options={
